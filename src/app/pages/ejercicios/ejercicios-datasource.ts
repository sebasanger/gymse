...
/**
 * Data source for the Ejercicios view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class EjerciciosDataSource extends DataSource<Ejercicio> {
  data: Ejercicio[] = [];
   ...
   */
  private getPagedData(data: Ejercicio[]): Ejercicio[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Ejercicio[]): Ejercicio[] {
